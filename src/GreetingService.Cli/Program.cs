...
public static class Program
{
    ...
    private const string TemplateMissingPlaceholderMessage = "greet: a greeting template must contain {name}";
    ...
    public static ComposeResult Compose(string[] args, string? environmentTemplate)
    {
        ...
        {
            return new ComposeResult(null, TemplateMissingPlaceholderMessage);
        }
